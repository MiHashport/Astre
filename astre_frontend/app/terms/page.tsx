    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-[var(--color-text-muted)]">
          Please read these terms carefully before using Astre.
        </p>
      </div>
      ...
      <section className="prose max-w-none">
        ...
        <p>
          By accessing or using Astre you agree to be bound by these Terms of
          Service.
        </p>
        ...
        <h2>4. Disclaimers</h2>
        <p>
          The service is provided &quot;as is&quot; without warranties. Astre is
