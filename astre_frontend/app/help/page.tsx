...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    id: 'how-transparent',
    category: 'General',
    question: 'How is Astre transparent?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Astre supports Freighter wallet and other Stellar-compatible wallets via the Stellar Wallets Kit. We recommend Freighter for the best experience. Make sure your wallet is set to the correct Stellar network.',
  },
  {
    id: 'create-pool',
  ...
  },
  {
    ...
    answer:
      'Astre itself charges no platform fees. You only pay the standard Stellar network fee (typically under $0.01 USD) to submit the smart contract transaction. The pool funds belong entirely to the creator and donors.',
  },
  {
    id: 'edit-pool',
    category: 'Creating Pools',
  ...
  },
  {
    id: 'testnet-mainnet',
    category: 'Blockchain',
    question: 'Is Astre on testnet or mainnet?',
    answer:
      'Astre is currently running on the Stellar testnet. Testnet XLM has no real value and is used for testing purposes. We will announce the mainnet launch separately. Make sure your Freighter wallet is pointed at the correct network.',
  },
];
