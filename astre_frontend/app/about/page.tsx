...
const TESTIMONIALS = [
  {
    quote:
      'Astre has revolutionized how we collect donations. The transparency and low fees make it perfect for our mission.',
    author: 'Maria Santos',
      ...
      <section aria-labelledby="about-heading" className="mb-16">
        <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-8">
          ...
          <p className="text-[var(--color-text-muted)] leading-relaxed mb-4">
            Astre was founded in 2024 with a simple goal: make charitable giving
      ...
      <section aria-labelledby="contact-heading">
        ...
        <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-8 text-center">
          <p className="text-[var(--color-text-muted)] mb-4">
            Have questions or want to learn more about Astre?
          </p>
