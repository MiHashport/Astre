    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="mt-3 max-w-2xl mx-auto text-[var(--color-text-muted)]">
          See how Astre pools are making a difference around the world. Every
      ...
      >
        ...
        <p className="mt-3 max-w-lg mx-auto text-sm text-[var(--color-text-muted)]">
          Have you created or contributed to a Astre pool that made a
          difference? We want to hear from you. Share your story and inspire
          others.
        </p>
