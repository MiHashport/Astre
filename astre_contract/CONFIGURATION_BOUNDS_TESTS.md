...
## Overview
This document describes the comprehensive test suite for validating configuration parameter bounds in the Astre smart contract. These tests ensure that all configuration constraints are properly enforced.
...
- [Contract Source](./contracts/astre_contract/src/lib.rs)
- [Test Suite](./contracts/astre_contract/src/test.rs)
