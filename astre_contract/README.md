# Astre Smart Contract

## Overview

Astre is a Soroban-based smart contract that enables decentralized donation pools for educational sponsorships. The contract manages the complete lifecycle of funding pools: creation, donations, student applications, approvals, milestone-based disbursements, and fund claims.
...
soroban contract deploy \
  --wasm astre_contract/target/wasm32-unknown-unknown/release/astre_contract.wasm \
