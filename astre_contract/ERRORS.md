# Astre Contract Error & Panic Catalogue

This document provides a comprehensive reference of all error conditions and panic messages in the Astre smart contract. It's intended for off-chain integrators (frontend, server, indexers) to understand what can go wrong and how to handle it.

## Overview

The Astre contract uses two error mechanisms:
