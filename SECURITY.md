...
The Astre team and community take the security of our application, backend services, and smart contracts very seriously. We appreciate responsible security research and disclosure.

## Supported Versions

We actively support and maintain the latest release of Astre on the `main` branch. Security fixes will be applied to the current active components:

| Component | Directory | Supported | Notes |
| --- | --- | --- | --- |
| Frontend | `astre_frontend/` | :white_check_mark: | Next.js frontend application |
| Backend Server | `astre_server/` | :white_check_mark: | NestJS API backend |
| Smart Contract | `astre_contract/` | :white_check_mark: | Soroban smart contracts on Stellar |

## Reporting a Vulnerability

**Please do not report security vulnerabilities through public GitHub issues.**

If you discover a security vulnerability in Astre (including frontend, backend authentication/authorization, or Soroban smart contracts), please disclose it responsibly using one of the following private methods:
...
- **Affected component(s)**: (`astre_frontend`, `astre_server`, or `astre_contract`)
...
Thank you for helping keep Astre and the Stellar ecosystem safe!
